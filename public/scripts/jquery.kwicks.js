...
(function($) {
	...
	var methods = {
		...
		expand : function(index, opts) {
			...
			return this.each(function() {
				var $this = $(this), kwick = $this.data('kwicks');
				...
				var expand = function() {
					...
					var $panels = kwick.$panels, expanded = $panels[index] || null;
		...
		select : function(index) {
			return this.each(function() {
				...
				if (index !== kwick.selectedIndex) {
					var $panels = kwick.$panels, selected = $panels[index] || null;
	...
	Kwick.prototype.calculatePanelSizes = function() {
		var opts = this.opts, containerSize = this.getContainerSize(true);
		...
		var numPanels = this.$panels.length, sumSpacing = this.panelSpacing * (numPanels - 1), sumPanelSize = containerSize - sumSpacing;
	...
	Kwick.prototype.getOffsetsForExpanded = function() {
		...
		var expandedIndex = this.expandedIndex, numPanels = this.$panels.length, spacing = this.panelSpacing, size = this.panelSize, minSize = this.panelMinSize, maxSize = this.panelMaxSize;
	...
	Kwick.prototype.updatePanelStyles = function() {
		var offsets = this.offsets, $panels = this.$panels, pDim = this.primaryDimension, pAlign = this.primaryAlignment, sAlign = this.secondaryAlignment, spacing = this.panelSpacing, containerSize = this.getContainerSize();
	...
	Kwick.prototype.initMenuBehavior = function() {
		...
		this.addEventHandler(this.$panels, 'click', function() {
			var $this = $(this), isSelected = $this.hasClass('kwicks-selected');
	...
	Kwick.prototype.initSlideshowBehavior = function() {
		var self = this, numSlides = this.$panels.length, curSlide = 0,
		// flag to handle weird corner cases
		running = false, intervalId;
	...
	Kwick.prototype.initWindowResizeHandler = function() {
		...
		var self = this, prevTime = 0, execScheduled = false, $window = $(window);
	...
	Kwick.prototype.destroy = function() {
		...
		.removeClass('kwicks-processed').removeData('kwicks');
	};
	...
	Kwick.prototype.expand = function(index) {
		...
		oldIndex = this.expandedIndex, oldExpanded = this.getExpandedPanel();
