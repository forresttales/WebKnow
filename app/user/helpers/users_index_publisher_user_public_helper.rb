module UsersIndexPublisherUserPublicHelper

  def index_publisher_user_public(user)
      ...
      begin
          ...
          LogError.create(:user_id => current_user.id, :profile_index => 3, :profile_description => 'publisher', :controller => 'users', :action => 'render_index_public_publisher_user', :description => e.message.to_s)
      end
