module ProductsHelper
  ...
  # def avatar_product_for(product, s_rand)
    # # img = user.user_images.where( :primary => true ).first rescue nil     
    # # if !img.nil?     
      # # user_avatar_url = img.image_url(:user_100_100)
    # # else
      # user_avatar_url = "../images_avatar/avatar-gen-product-w100-h100.png"
    # # end
      # image_tag(user_avatar_url + s_rand, alt: "", class: "")
  # end  
  # def avatar_200_product_for(product, s_rand)
    # publisher_logo_avatar_url = "../images_avatar/avatar-gen-product-w200-h200.png"
    # img = product.publisher_product_pos1_image rescue nil
    # # img = product.publisher_product_logos.where( :primary => true ).first rescue nil
    # if !img.nil?     
      # publisher_logo_avatar_url = img.image_url(:user_200_200)
    # end
      # image_tag(publisher_logo_avatar_url + s_rand, alt: "", class: "")
  # end  
