class PublisherUserImagesController < ApplicationController

  require 'RMagick'
  
  layout 'publisher_user_image'
  # layout 'publisher'
  ...
  def create
    ...
    @publisher_user_image = PublisherUserImage.new(publisher_user_image_params)
    @publisher_user_image.user_id = current_user.id

    if @publisher_user_image.save
      # if params[:publisher_user_image][:image].present?
        # render :crop
      # else
  ...
  def update
    ...
    if @publisher_user_image.update_attributes(publisher_user_image_params)
...
# 
  ...
  def destroy
    ...
    if @publisher_user_image.destroy
      ...
      render text: 'publisher_user_image destory failed'
    end
  ...
  private
    ...
    def publisher_user_image_params
      params.require(:publisher_user_image).permit(      
                                                  :user_id,
                                                  :publisher_id,
                                                  :publisher_user_id,
                                                  :image,
