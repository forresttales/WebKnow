class PublisherProduct2ImagesController < ApplicationController
  ...
  def index
    ...
    @publisher_product2_image = PublisherProduct2Image.where("publisher_product_id = ?", @publisher_product_id).first
  ...
  def new
    ...
    @publisher_product2_image = PublisherProduct2Image.new(:publisher_id => params[:publisher_id], :publisher_product_id => params[:publisher_product_id])
  ...
  def create
    ...
    # @publisher_product2_image = PublisherProduct2Image.new(params[:painting])
    @publisher_product2_image = PublisherProduct2Image.new(publisher_product2_image_params)
    # @publisher_product2_image.publisher_id = params[:publisher_product2_image][:publisher_id]
    # @publisher_product2_image.publisher_product_id = params[:publisher_product2_image][:publisher_product_id]
    publisher_id = params[:publisher_product2_image][:publisher_id]
    publisher_product_id = params[:publisher_product2_image][:publisher_product_id]
    descr = params[:publisher_product2_image][:descr]
    ...
    if @publisher_product2_image.save
      ...
      if descr.to_s == '1'
        ...
        redirect_to :controller => 'publisher_product2_images', :action => 'index', :params => { :publisher_id => publisher_id, :publisher_product_id => publisher_product_id }
      end      
    ...
    # render text: @publisher_product2_image.image_name
    ...
    # # h_update['product_image'] = @publisher_product2_image.image_name
...
# 
    # if publisher_product.update_columns( h_update )
      ...
      # # else
          # # # session[:publisher_product2_image_upload_status] = false
          # # render 'create'        
      # # end    
    # else
  ...
  def edit
    render text: 'edit publisher_product2_image'
  ...
  def update
    ...
    render text: 'update publisher_product2_image'
  ...
  def destroy
    ...
    render text: session[:publisher_product2_image_id]
    
    # publisher_id = params[:publisher_id]
    # publisher_product_id = params[:publisher_product_id]
    # publisher_product2_image_id = params[:publisher_product2_image_id]
    
    

    # http://localhost:3000/publisher_product2_images?publisher_id=2&publisher_product_id=1
    # http://localhost:3000/publisher_product_descriptions?publisher_id=2&publisher_product_id=1
    
    # publisher_product2_image = PublisherProduct2Image.find(publisher_product2_image_id)
    # publisher_product2_image = PublisherProduct2Image.find(params[:id])
    # if publisher_product2_image.destroy
      # # redirect_to :controller => 'publisher_product_descriptions', :action => 'index', :params => { :publisher_id => publisher_id, :publisher_product_id => publisher_product_id }
      # redirect_to :controller => 'publisher_product2_images', :action => 'index', :params => { :publisher_id => publisher_id, :publisher_product_id => publisher_product_id }
# 
      # # redirect_to :controller => 'publisher_product2_images', 
                  # # :action => 'index', 
                  # # :params => { :publisher_id => publisher_id, :publisher_product_id => publisher_product_id, :publisher_product2_image_id => publisher_product2_image_id }
    # else
      # #
    # end
...
# 
# 
    # img = PublisherProduct2Image.find(params[:image_id])
...
#      
# 
    # # /publisher_product2_images?publisher_id=1&publisher_product_id=1
    # # @@publisher_product_id = @publisher_product_id 
    # # @@publisher_id = @publisher_id
# 
    ...
    # url_redirect = "/publisher_product2_images?publisher_id=" + @@publisher_id.to_s + "&publisher_product_id=" + @@publisher_product_id.to_s
  ...
  private
    ...
    def publisher_product2_image_params
      params.require(:publisher_product2_image).permit(      
                                                      :publisher_id,
