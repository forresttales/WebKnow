# == Schema Information
#
# Table name: publisher_product_from_grades
#
...
class PublisherProductFromGrade < ActiveRecord::Base
  ...
  def self.dbdelete
      self.connection.execute("DELETE FROM publisher_product_from_grades")
  end
  
  def self.dbclear
      self.connection.execute("ALTER SEQUENCE publisher_product_from_grades_id_seq RESTART WITH 1")
  end
