# == Schema Information
#
# Table name: publisher_product_from_ages
#
...
class PublisherProductFromAge < ActiveRecord::Base
  ...
  def self.dbdelete
      self.connection.execute("DELETE FROM publisher_product_from_ages")
  end
  
  def self.dbclear
      self.connection.execute("ALTER SEQUENCE publisher_product_from_ages_id_seq RESTART WITH 1")
  end
